...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/home/hmenager/mobyle2.github.com/source/eggs/distribute-0.6.24-py2.7.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/home/hmenager/mobyle2.github.com/source/eggs/distribute-0.6.24-py2.7.egg',
        '/home/hmenager/mobyle2.github.com/source/eggs/zc.buildout-1.5.2-py2.7.egg'
        ]
    ...
    original_paths = [
        '/usr/local/lib/python2.7/dist-packages/PyCAPTCHA-0.4-py2.7.egg',
